            ...
            <div className="grid">
                <div className="col-12">
                    <div className="card docs">
                        ...
                        <p>
                            Diolay is an application template for React based on the popular{' '}
                            ...
                            <a href="https://github.com/primefaces/Diolay-react-next.js" className="font-medium hover:underline text-primary">
                                repository
                            </a>{' '}
                        ...
                        <p>
                            Next step is running the application using the start script and navigate to <b>http://localhost:3000/</b> to view the application. That is it, you may now start with the development of your application using the Diolay
                            template.
                        </p>
...
`}</code>
                        ...
                        <h5>Structure</h5>
                        <p>Diolay consist of a couple of folders where demos and core layout have been separated.</p>
                        <p>
                            There are two{' '}
...
export const LayoutProvider = (props) => {
    const [layoutConfig, setLayoutConfig] = useState({
        ...
        scale: 14                               //size of the body font size to scale the whole application
                        ...
                        <p>
                            Diolay theming is based on the PrimeReact theme being used.
                        </p>
